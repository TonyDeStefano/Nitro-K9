...
if ( isset( $_GET['nitro_k9_id'] ) && isset( $_GET['nitro_k9_hash'] ) )
{
	...
	if ( strlen( $entry->getHash() ) > 0 && $entry->getHash() == $_GET['nitro_k9_hash'] && $entry->getCompletedAt() === NULL )
	{
...
<?php if ( isset( $_GET['complete'] ) && $_GET['complete'] == 'true' ) { ?>
	...
	<div class="alert alert-success">
		Thank you! Your information has been submitted. We will be in touch with you soon.
	</div>
	...
	<form method="post" class="form-horizontal nitro-k9-form">
		...
		<?php } elseif ( $entry->getCurrentStep() == \NitroK9\Entry::STEP_CONFIRM ) { ?>
			...
			<div class="alert alert-info">
				If everything looks correct, please press the "Complete Sign-Up" button below.
			</div>
